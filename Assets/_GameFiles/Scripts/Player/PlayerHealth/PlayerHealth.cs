...
public /*тут надо поработать с абстракцией*/ sealed class PlayerHealth //Эта реализация буквально дублируется в Character, то есть, это сервис, который можно РЕЮЗАТЬ И ПОДМЕНЯТЬ (ПЕРЕДЕЛАТЬ);
{
